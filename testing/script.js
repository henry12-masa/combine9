...
const quizInfo = {
  istqbFoundation: {
    ...
    desc: "テスト基礎、テストプロセス、静的テスト、テスト設計技法、マネジメント、ツール支援"
  },
  istqbAdvancedTestAnalyst: {
    title: "ISTQB Advanced Test Analyst",
    desc: "高度なテスト分析、ブラックボックス技法、ユーザビリティ、欠陥管理、レビュー、品質特性"
  },
  certifiedAgileTester: {
    title: "Certified Agile Tester",
    desc: "アジャイル原則、スクラム、テスト自動化、探索的テスト、CI/CD、チーム協働"
  }
};
...
if (type === "all") {
  document.title = "ISTQB・Agile Tester資格クイズ";
  pageTitle.textContent = "ISTQB・Agile Tester資格クイズ";
  pageDesc.textContent = "3カテゴリ・各180問から50問ランダムで出題";
} else {
  const info = quizInfo[type] || quizInfo.istqbFoundation;
