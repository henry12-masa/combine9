...
const quizInfo = {
  oracleLinuxOcp: {
    title: "Oracle Linux Certified Professional",
    desc: "Oracle Linux管理、Ksplice、UEK、DTrace、セキュリティ、ストレージ、仮想化、トラブルシューティング"
  },
  suseSca: {
    title: "SUSE Certified Administrator",
    desc: "SLES基礎、YaST、zypper、systemd、ネットワーク、ユーザー管理、ストレージ、基本セキュリティ"
  },
  suseSce: {
    title: "SUSE Certified Engineer",
    desc: "高度なSLES運用、HA、Btrfs/Snapper、AutoYaST、セキュリティ、監視、トラブルシューティング"
  }
};
...
if (type === "all") {
  document.title = "Oracle Linux・SUSE資格クイズ";
  pageTitle.textContent = "Oracle Linux・SUSE資格クイズ";
  pageDesc.textContent = "3カテゴリ・各180問から50問ランダムで出題";
} else {
  const info = quizInfo[type] || quizInfo.oracleLinuxOcp;
