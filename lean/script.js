...
const quizInfo = {
  yellowBelt: {
    ...
    desc: "Lean Six Sigmaの基礎、ムダ、5S、DMAIC、基本的な品質改善の理解"
  },
  greenBelt: {
    title: "Lean Six Sigma Green Belt",
    desc: "DMAIC実践、データ分析、工程能力、原因分析、改善案評価、管理計画"
  },
  blackBelt: {
    title: "Lean Six Sigma Black Belt",
    desc: "高度な統計、実験計画、リーダーシップ、プロジェクト選定、変革推進"
  }
};
...
if (type === "all") {
  document.title = "Lean Six Sigma資格クイズ";
  pageTitle.textContent = "Lean Six Sigma資格クイズ";
  pageDesc.textContent = "3カテゴリ・総数180問から50問ランダムで出題";
} else {
  const info = quizInfo[type] || quizInfo.yellowBelt;
